								...
								<form
									...
									<label className='form-input-label'>
										...
										<div className='password-container'>
											...
											<img
												...
												src={passwordReveal}
												alt='toggle password'
												onClick={e => this.toggleReveal(e, 0)}
											/>
										</div>
									</label>
									...
									<label className='form-input-label'>
										...
										<div className='password-container'>
											<input
												type={
													this.state.passwordConfirmReveal ? 'text' : 'password'
												}
												name='passwordCheck'
											...
											<img
												...
												src={passwordReveal}
												alt='toggle password'
												onClick={e => this.toggleReveal(e, 1)}
											/>
										</div>
									</label>
									<p className='form-input-error'>
									...
									<div className='tos'>
										<input
											...
											name='tosCheck'
											id='tosCheck'
											value={this.state.credentials.tosCheck}
											onChange={this.handleChange}
										/>
										<label for='tosCheck' className='tos-text'>
											I agree to the{' '}
											<a href='google.com' className='tos-text-link'>
												Terms and Conditions
											</a>
										</label>
									</div>
									<p className='form-input-error'>
										{this.state.errors.tosCheck}
									</p>
									...
									<div className='sign-up-automatic mobile'>
										<div className='firebase-buttons mobile'>
											<button
												onClick={() =>
													signUpThroughFirebase('google', this.props.history)
												}
											...
											<button
												onClick={() =>
													signUpThroughFirebase('facebook', this.props.history)
												}
												className='social-sign-in facebook'>
												<img
													className='button-img'
													src={facebook}
